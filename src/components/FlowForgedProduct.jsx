...
import "./FlowForgedProduct.css";

const FlowForgedProduct = ({ productName, img, cars, id }) => {
  ...
  return (
    <div className="flowforged_product">
      <div className="img_container" onClick={() => navigateToProduct(id)}>
        <img src={img} alt="" />
      </div>
      <div className="flowforged_info">
...
export default FlowForgedProduct;
